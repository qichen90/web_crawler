...
class AppstoreMongodbPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        :return: item
        """
        collection_name = item.__class__.__name__  # use itemName as the collectionName:AppstoreItem
        ## todo: only need to clean the collection at very first time loading mongodb
